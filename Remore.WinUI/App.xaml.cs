...
using Remore.WinUI.Notifications;
...
public partial class App : Application
{
    ...
    public static DispatcherQueue DispatcherQueue => App.MainWindow.DispatcherQueue;
    ...
    protected async override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        await App.GetService<HttpService>().InitializeAsync();
        await App.GetService<AuthService>().InitializeAsync();
